...
static const char qt_meta_stringdata_fenetre[] = {
    "fenetre\0\0name\0changerFenetre(QString)\0"
};
...
void fenetre::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->changerFenetre((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject fenetre::staticMetaObject = {
    { &QStackedWidget::staticMetaObject, qt_meta_stringdata_fenetre,
